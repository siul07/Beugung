...
- $ Radiobutton\ Aufbau $:
  ...
  - $ Doppelspalt $
- $ Slider $:
  - $ \lambda\ [\mathrm{nm}] $ – Wellenlänge des Lichts $ \lambda $
  - $ a\ [\mathrm{\mu m}] $ – Spaltbreite $ a $
  - $ d\ [\mathrm{\mu m}] $ – Spaltabstand $ d $ (nur relevant im Doppelspalt)
  - $ L\ [\mathrm{m}] $ – Abstand Spalt–Schirm $ L $
  - $ x_{\max}\ [\mathrm{mm}] $ – halbe Breite des beobachteten Schirmbereichs  
